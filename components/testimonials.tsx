...
export function Testimonials() {
  ...
  return (
    <div className="py-16 md:py-24 bg-green-50">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center mb-10">
          <h2 className="text-3xl font-bold tracking-tight text-green-800 sm:text-4xl md:text-5xl">
            {t("testimonials.title")}
          </h2>
          <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-[700px]">
        ...
        <div className="relative mx-auto max-w-4xl">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              transition={{ duration: 0.3 }}
              className="relative rounded-xl bg-white dark:bg-gray-800 p-8 shadow-lg border border-green-100"
            >
              <div className="absolute -top-5 left-8 text-green-600 dark:text-green-400">
                <Quote className="h-10 w-10" />
              </div>
              <div className="pt-4">
                ...
                <div className="flex items-center">
                  <div className="mr-4 h-12 w-12 overflow-hidden rounded-full border-2 border-green-100">
                    <Image
                      src={
            ...
            <div className="flex items-center gap-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  aria-label={t("testimonials.goToTestimonial", {
