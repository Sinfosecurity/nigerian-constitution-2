...
//             >
//               <div className="mb-4 rounded-full bg-white p-4 shadow-md dark:bg-gray-800">
//                 {stat.icon}
//               </div>
...
export function Statistics() {
  ...
  return (
    <div className="bg-green-50 dark:bg-gray-900 py-16">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center"
            >
              <div className="mb-4 rounded-full bg-white p-4 shadow-md dark:bg-gray-800 border border-green-100">
                {stat.icon}
              </div>
              <h3 className="text-3xl font-bold text-green-800 md:text-4xl">
                {stat.prefix || ""}
                {stat.value.toLocaleString()}
                {stat.suffix || ""}
              </h3>
              <p className="text-green-600 dark:text-green-400">{stat.label}</p>
            </motion.div>
          ))}
        </div>
      </div>
