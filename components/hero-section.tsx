...
import { Search, ArrowRight, BookOpen, Shield, Scale, Users } from "lucide-react"
      ...
      <div className="container relative z-10 px-4 py-16 md:py-24 lg:py-32">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="max-w-[600px] text-gray-600 dark:text-gray-300 text-xl">{t("hero.subtitle")}</p>
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <p>
                <span className="font-medium text-gray-900 dark:text-white">10,000+</span> {t("hero.userCount")}
              </p>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <h2 className="text-center text-3xl font-bold tracking-tight mb-12">{t("hero.featuresTitle")}</h2>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              ...
              >
                <div className="mb-4 rounded-full bg-blue-50 p-3 dark:bg-blue-900/30">{feature.icon}</div>
