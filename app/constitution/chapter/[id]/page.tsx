    ...
    sections: Array.from({ length: 10 }, (_, i) => ({
      ...
      content:
        i === 0
          ...
          : `Sample content for section ${i + 1} of chapter ${chapterId}. This would contain the actual text of the Nigerian Constitution.`,
    })),
  }
      ...
      <main className="flex-1">
        <div className="container px-4 py-6 md:px-6 md:py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-8">
            <div>
              <h1 className="text-3xl font-bold tracking-tighter">{chapterData.fullTitle}</h1>
              ...
              <Card>
                <CardContent className="p-6">
                  {chapterData.sections.map((section) => (
                    <div key={section.id} className="mb-8" id={`section-${section.id}`}>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="bg-muted p-4 rounded-lg mb-6">
                    <p className="text-sm">
                      This is a simplified explanation of {chapterData.fullTitle}. It is not a legal document and should
                      not be used as a substitute for the official text of the Constitution.
                    </p>
                  </div>
            ...
            <TabsContent value="annotations" className="mt-6">
              <Card>
                <CardContent className="p-6">
                  <div className="bg-muted p-4 rounded-lg mb-6">
                    <p className="text-sm">
                      These annotations provide additional context, relevant court cases, and interpretations of{" "}
                      {chapterData.fullTitle}. They are for educational purposes only.
                    </p>
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border-l-4 border-primary pl-4 py-2">
                          ...
                          <p className="text-sm mt-2">
                            The Supreme Court has consistently upheld the supremacy of the Constitution in numerous
                            cases, establishing that no government action can override constitutional provisions.
                          </p>
                        </div>
                      </div>
                    </div>
